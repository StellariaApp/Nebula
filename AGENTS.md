# Nebula — guía para sesiones de Codex
...
Gobernanza operativa en `.Codex/skills/` (12 skills — ver su README): empezar por `project-guardrails`, aplicar la skill de capa correspondiente y validar con `quality-gates`.
