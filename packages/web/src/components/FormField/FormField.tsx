...
const FormFieldImpl = forwardRef<HTMLElement, FormFieldOwnProps>(function FormField(props, ref) {
  const {
    component,
    label,
    description,
  ...
  return (
    <Box ref={ref} component={component ?? "div"} className={cx(styles.root, className)} {...rest}>
      {has_header ? (
...
export const FormField = FormFieldImpl as unknown as FormFieldComponent;
