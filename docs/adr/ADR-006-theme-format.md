...
- **Consecuencias**: un único artefacto de tema alimenta ambas plataformas; el Theme Creator hace round-trip (import/edit/export); un tema "radical" actúa como test de que ningún componente lee fuera del theme.
