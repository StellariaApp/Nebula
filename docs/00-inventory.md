...
| Scroll                                      | prim   | WN   | 1    | P2·P3·ST·FC                                 | core    | ST Scroll (+gesture inyectable de FC)                                    |
...
| AppShell (+Header/Navbar/Aside/Footer/Main) | comp   | W    | 1    | P3·TFV(Navbar/Sidebar/Footer/Aside/Sidenav) | core    | Nuevo; absorbe el shell de TFV                                           |
...
| ActionIcon (+Group)  | prim  | WN   | 1    | P2·P3·ST(Action)·FC(Action)·TFV | core    | ST Action                              |
...
| Banner (hero)                           | comp   | W    | 2    | TFV                          | core      | C1-Q5: aprobado como adición al catálogo                                                                                                                                               |
...
| 11  | Banner                | Banner                               | core              | C1-Q5: adición aprobada                                              |
