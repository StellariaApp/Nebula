...
| Sombra calibrada por esquema                               | los temas importan el mismo `shadows` de tokens (`nebula-dark.ts:85`, `nebula-light.ts:64`) | en dark, negro al 5–24 % sobre `#0b0b0b` es invisible                                                                          | refinar ahora                                     | **P0** | `packages/themes/src/themes/shadows.ts` (nuevo, interno), `nebula-dark.ts` |
