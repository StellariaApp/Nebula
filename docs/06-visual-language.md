...
- **El escalón mínimo entre dos niveles adyacentes es 1.08** (ADR-065), **implementado en B3**. La
  ...
  | `light` | `light.800` | `light.600` | `light.400` | `light.50` |
...
3. **Themes**: `dark` y `light` con la misma estructura.
...
- ¿Los temas siguen produciendo el mismo componente, no forks visuales?
