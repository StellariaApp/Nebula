...
| [07-recetas-de-producto.md](07-recetas-de-producto.md)         | **Recetas de consumidor**: cómo se compone un producto de Stellaria con el catálogo (raíz, tema, Main/Nav/dock, AppShell en carril, Screen y cabeceras que se encogen, modales, estados, medios, i18n), huecos conocidos y checklist. Rúbrica de `prompts/6-consumidores/C3` |
